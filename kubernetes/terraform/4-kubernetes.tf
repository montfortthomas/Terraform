...
# 3. death certificate -> 
# 4. statement (Oral) -> 
# 5. land details Private & details -> 
# 6. case file statement, 4 members
# 7. complaint aadhar details
# 8. thai pathiram (motherdeed), EC, Register (Jesu)
# 9. Income certificate (PPL Certificate,pancard, Ration Card)
# 11. land sketch -> village map.
